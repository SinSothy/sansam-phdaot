...
const TASK_TYPES = [
  { id: 'dark-blue', color: 'bg-primary', label: 'Default' },
...
export default function CreateTaskDialog({ isOpen, onClose, selectedDate, editTask, onSave }: CreateTaskDialogProps) {
  ...
  const formatDisplayDate = (d: Date) => d.toLocaleDateString('en-US', { month: 'short', day: 'numeric', year: 'numeric' });
  const formatDisplayTime = (d: Date) => d.toLocaleTimeString('en-US', { hour: 'numeric', minute: '2-digit', hour12: true });
    ...
    <div className="fixed inset-0 z-[100] flex items-center justify-center bg-black/40 backdrop-blur-sm px-4">
      ...
      >
        ...
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-[22px] font-extrabold text-on-surface">New Task</h2>
        ...
        <div className="flex items-center gap-4 mb-8">
          <div className="flex-1 relative">
            <label className="block text-[10px] font-bold text-secondary uppercase tracking-widest mb-3">Start Date</label>
            <div
          ...
          <div className="flex-1 relative">
            <label className="block text-[10px] font-bold text-secondary uppercase tracking-widest mb-3">End Date</label>
            <div
        ...
        <div className="flex items-center gap-6 mb-8 relative z-50">
          <div className="flex-1">
            <label className="block text-[10px] font-bold text-secondary uppercase tracking-widest mb-3">Owner</label>
            <OwnerSelect value={owner} onChange={setOwner} />
          </div>
          
          <div className="flex-1">
            <label className="block text-[10px] font-bold text-secondary uppercase tracking-widest mb-3">Priority / Type</label>
