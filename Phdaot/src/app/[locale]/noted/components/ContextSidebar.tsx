      ...
      <div className="p-6 overflow-y-auto space-y-8 custom-scrollbar">
        ...
        <div>
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-sm font-black uppercase tracking-widest text-secondary">{t('linkedTasks')}</h3>
            <span className="bg-primary/10 text-primary text-[10px] px-2 py-0.5 rounded-full font-bold">{t('activeTasks', {count: 4})}</span>
          </div>
          <div className="space-y-3">
            <div className="p-4 bg-surface-container-lowest rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer">
              <div className="flex justify-between items-start mb-2">
                <span className="text-[10px] px-2 py-0.5 bg-error-container text-on-error-container rounded-md font-bold uppercase">{t('highPriority')}</span>
              ...
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] font-medium text-secondary">{t('due', {date: 'Oct 14'})}</span>
              </div>
            </div>
            ...
            <div className="p-4 bg-surface-container-lowest rounded-xl shadow-sm hover:shadow-md transition-shadow cursor-pointer opacity-80">
              ...
              <div className="flex items-center gap-2">
                <span className="material-symbols-outlined text-xs text-secondary">calendar_today</span>
                <span className="text-[10px] font-medium text-secondary">{t('due', {date: 'Oct 16'})}</span>
              </div>
            </div>
          </div>
        ...
        <div>
          <h3 className="text-sm font-black uppercase tracking-widest text-secondary mb-4">{t('referencedInNote')}</h3>
        ...
        <div className="pt-6 border-t border-surface-container">
          <h3 className="text-sm font-black uppercase tracking-widest text-secondary mb-2">{t('mentions')}</h3>
