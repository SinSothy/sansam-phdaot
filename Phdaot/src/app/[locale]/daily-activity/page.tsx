    ...
    <div className="flex flex-col h-full bg-surface text-on-surface font-body overflow-hidden">
      ...
      <div className="flex-1 flex overflow-hidden">
          ...
          <div className="w-72 bg-surface-container-low p-6 overflow-y-auto hidden lg:block shrink-0">
              ...
              <div className="mb-8">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-secondary mb-4">{t('jumpToDate')}</h3>
                  {renderJumpToDate()}
              </div>

              <div className="mb-8">
                  <h3 className="text-xs font-bold uppercase tracking-widest text-secondary mb-4">{t('myCalendars')}</h3>
              ...
              <div>
                  <h3 className="text-xs font-bold uppercase tracking-widest text-secondary mb-4">{t('team')}</h3>
          ...
          {viewMode === "Week" && <WeekView currentDate={currentDate} events={events} onDayClick={handleDayClick} onTaskClick={handleTaskClick} onEventUpdate={handleEventUpdate} />}
          {viewMode === "Day" && (
            <DayView 
              currentDate={currentDate} 
              events={events} 
