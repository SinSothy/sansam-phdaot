    ...
    <section>
      <div className="flex items-center justify-between mb-8">
        <div className="flex items-center gap-3">
          ...
          <h3 className="text-lg font-bold font-headline uppercase">Your Workspaces</h3>
        </div>
      </div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h4 className="font-bold text-base">Design System Team</h4>
          </div>
          <div className="flex items-center gap-2 ml-auto">
            <button className="px-3 py-1.5 bg-surface-container-low text-xs font-semibold rounded-lg hover:bg-surface-container-high transition-all">Boards</button>
            <button className="px-3 py-1.5 text-xs font-semibold rounded-lg hover:bg-surface-container-high transition-all">Members (12)</button>
            <button className="px-3 py-1.5 text-xs font-semibold rounded-lg hover:bg-surface-container-high transition-all">Settings</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <Link href="/planner" className="group relative h-40 rounded-xl overflow-hidden cursor-pointer bg-surface-container-lowest transition-all hover:shadow-2xl hover:-translate-y-1 block">
            ...
            <div className="p-4">
              <p className="font-bold text-sm text-on-surface">Component Library</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="w-2 h-2 rounded-full bg-emerald-500" />
                <span className="text-[10px] font-bold text-secondary uppercase tracking-tighter">Active</span>
              </div>
            </div>
          </Link>
          {/* Card 5 */}
          <Link href="/planner" className="group relative h-40 rounded-xl overflow-hidden cursor-pointer bg-surface-container-lowest transition-all hover:shadow-2xl hover:-translate-y-1 block">
            ...
            <div className="p-4">
              <p className="font-bold text-sm text-on-surface">Documentation Hub</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="w-2 h-2 rounded-full bg-amber-500" />
                <span className="text-[10px] font-bold text-secondary uppercase tracking-tighter">Updating</span>
              </div>
            </div>
          </Link>
          {/* Card 6 */}
          <Link href="/planner" className="group relative h-40 rounded-xl overflow-hidden cursor-pointer bg-surface-container-lowest transition-all hover:shadow-2xl hover:-translate-y-1 block">
            ...
            <div className="p-4">
              <p className="font-bold text-sm text-on-surface">Brand Assets</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="w-2 h-2 rounded-full bg-emerald-500" />
                <span className="text-[10px] font-bold text-secondary uppercase tracking-tighter">Active</span>
              </div>
          ...
          <Link href="/planner" className="group relative h-40 rounded-xl overflow-hidden cursor-pointer bg-surface-container-lowest transition-all hover:shadow-2xl hover:-translate-y-1 block">
            ...
            <div className="p-4">
              <p className="font-bold text-sm text-on-surface">Archive 2023</p>
              <div className="flex items-center gap-2 mt-2">
                <span className="w-2 h-2 rounded-full bg-slate-300" />
                <span className="text-[10px] font-bold text-secondary uppercase tracking-tighter">Archived</span>
              </div>
            </div>
          </Link>
        </div>
      ...
      <div className="mb-10">
        <div className="flex items-center gap-4 mb-4">
          ...
          <div>
            <h4 className="font-bold text-base">Mobile App Development</h4>
          </div>
          <div className="flex items-center gap-2 ml-auto">
            <button className="px-3 py-1.5 text-xs font-semibold rounded-lg hover:bg-surface-container-high transition-all">Boards</button>
            <button className="px-3 py-1.5 text-xs font-semibold rounded-lg hover:bg-surface-container-high transition-all">Members (8)</button>
          </div>
        </div>
        ...
        <div className="grid grid-cols-4 grid-rows-2 gap-4 h-64">
          <Link href="/planner" className="col-span-2 row-span-2 bg-primary-container/10 rounded-2xl p-6 flex flex-col justify-between group cursor-pointer hover:bg-primary-container/20 transition-all block">
            <div>
              <h5 className="text-primary font-black text-xl font-headline">App Launch Master</h5>
              <p className="text-sm text-primary/70 mt-2">Central hub for all launch deliverables and cross-functional syncing.</p>
            </div>
          ...
          <div className="col-span-2 row-span-1 border-2 border-dashed border-outline-variant bg-transparent rounded-xl flex items-center justify-center gap-3 cursor-pointer group hover:bg-surface-container-low transition-all">
            ...
            <span className="font-bold text-sm text-secondary">New Board in Mobile App</span>
          </div>
        </div>
      </div>
    </section>
